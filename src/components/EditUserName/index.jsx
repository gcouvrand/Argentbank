    ...
    return(
        ...
        <div className="header">
            ...
            <div className="input-section">
                <input type="text" className="input" placeholder={firstName} onChange={props.changeFirstName}/>
                <input type="text" className="input" placeholder={lastName} onChange={props.changeLastName}/>
            </div>
            <div className="button-section">
                <button className="buttons" onClick={props.save}>Save</button>
                <button className="buttons" onClick={props.cancel}>Cancel</button>
            </div>
        </div>
    )
}
